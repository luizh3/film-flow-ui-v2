    ...
    */
    ...
    MouseArea {
        ...
        onPositionChanged: function (mouse) {
            ...
            var newWidth = Math.floor(root.learp(
                                          ApplicationWindow.window.width,
            ...
            const actualWidth = ApplicationWindow.window.minimumWidth

            ApplicationWindow.window.width = newWidth

            ApplicationWindow.window.x = root._windowPreviusX - Math.floor(
                        widthDiff)
        }
    }
