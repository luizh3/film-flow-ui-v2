...
{
    _multiRequest->setDsLanguage(UiControlManager::instance().languageManager().dsLocaleBCP47());
    ...
    const MovieInformation *movieInformation)
{
    ...
    searchProgramCard->tpProgram = TypeProgramEnumMapper::toModel(movieInformation->tpProgram());
